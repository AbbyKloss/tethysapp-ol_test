...
img_path = "/Users/chluser/tethysdev/tethysapp-ol_test/tethysapp/ol_test/public/images/map.png"

im = Image.open(img_path)
siz = inch * 5.25
print(siz)
idealW, idealH = siz, siz
# print(im.size)
width, height = im.size
top, bot, lef, rig = 0, 0, 0, 0
top = (height / 2) - (idealH / 2)
bot = (height / 2) + (idealH / 2)
lef = (width / 2) - (idealW / 2)
rig = (width / 2) + (idealW / 2)
im = im.crop((lef, top, rig, bot))
im.save("here.png")
